...
> **Статус:** рабочий MVP операторского контура: форма, карта, черновик, загрузка фото, LLM-проверка текста с определением категории и количества свай, отправка заявки в pending + доставка на email через SMTP (biz.mail.ru / smtp.mail.ru).  
...
Фронт использует авторскую тему **Sky Pro** — тёмно-синяя (#0f2d8a) + оранжевая (#e06c00) палитра без внешних UI-библиотек.
