...
**Статус** — операторский контур работает (форма, карта, фото, LLM, отправка в приёмник/письмом), desktop-обёртка собрана. Идёт выкатка: приёмник в прод, сквозной прогон, публикация.
